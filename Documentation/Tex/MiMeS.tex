...
%
\begin{itemize}
 	\item {\tt std::vector<std::vector<LD>> points}}: Points of integration
	\item {\tt std::vector<std::vector<LD>> peaks}
	\item {\tt std::vector<LD> dtheta}
	\item {\tt std::vector<LD> dzeta}
\end{itemize}
