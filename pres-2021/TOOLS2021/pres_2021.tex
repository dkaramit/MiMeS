...
\vspace*{-0.5cm}
\date{\bl{		
		24/11/2021}\\{\sl Computational Tools for High Energy Physics and Cosmology\\ {\fontF Institut de Physique des 2 Infinis
		Lyon, France}}\\[0.5cm]
	
	Detailed documentation:
	\href{https://arxiv.org/abs/2110.12253}{\textbf{arXiv:2110.12253}}\\
	Github:
	\href{https://github.com/dkaramit/MiMeS}{\textbf{github.com/dkaramit/MiMeS}}\\
	HEPForge:
	\href{https://mimes.hepforge.org/}{\textbf{mimes.hepforge.org}}\\[1.5cm]
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	\begin{frame}[noframenumbering,plain]
		\titlepage
	\flushbottom{\fontsize{5}{1}\selectfont Supported by the Lancaster–Manchester–Sheffield Consortium for Fundamental
	Physics, under STFC research grant \bl{ST/T001038/1}.}\nonumber
...
\begin{frame}{\insertsubsectionhead}
	...
	\begin{itemize}
		...
		\item There are no constants of motion.~\footnote{There is the adiabatic invariant, $J$, but it only helps us if the Hamiltonian varies slowly.}
...
\subsection{\mimes}
\begin{frame}{\insertsubsectionhead}
	We need accurate code that solves the EOM, but most importantly we need {\sl reproducible} results! \\[0.1cm]
...
%	\end{equation*} 
%	%
%	with $\ai$ some initial value of the scale factor.~\footnote{\fontF Only the ratios $a/\ai$ appear in the calculations.}	Then, the EOM becomes
%	%
...
\begin{frame}[fragile]{\insertsubsectionhead}
	...
	\begin{itemize}
		...
		\begin{itemize}
			...
			\item \cppin{OPT=O1}, \cppin{O2}, or \cppin{O3}: all these perform mostly the same (read the compiler documentation for more information on the optimization).
...
\begin{frame}[fragile]{\insertsubsectionhead}
	...
	\begin{enumerate}
		...
		\item $\dot \theta(0)=0$. This will be changed in the future.\pause
...
\begin{frame}[fragile]{\insertsubsectionhead}
	...
	\begin{enumerate}
		...
		\item At which point the adiabatic invariant is constant  enough so that numerical integration can stop.\pause
...
\begin{frame}[fragile]{\insertsectionhead}
	...
	%
	\begin{itemize}
		\item \mimes should allow the user to consider different initial value of $\dot \theta$; the "kinematic" \mimes might come soon.
