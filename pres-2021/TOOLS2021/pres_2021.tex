...
\vspace*{-0.5cm}
\date{\bl{		
		24/11/2021}\\{\sl Computational Tools for High Energy Physics and Cosmology\\ {\fontF Institut de Physique des 2 Infinis (IP2I)
		Lyon, France}}\\[1cm]
	...
	HEPForge:
	\href{https://mimes.hepforge.org/}{\textbf{mimes.hepforge.org}}
...
\begin{frame}{\insertsubsectionhead}
	We need accurate code that solves the EOM, but most importantly we need {\sl reproducible} results! \\[1cm]
	...
	\begin{itemize}
		...
		%
		\item \mimes is distributed under the MIT license; you can do whatever you want with it, and I am {\em not} responsible.\\[1.cm]
	\end{itemize}
...
\begin{frame}[noframenumbering]
	...
	\begin{figure}\vspace{1.cm}
		\hspace*{-8cm}\href{https://github.com/dkaramit/MiMeS}{ \includegraphics[width=2.5cm]{GitHub.png} }
	\end{figure}
	\begin{figure}\vspace{-3.1cm}
		\hspace*{8cm}\href{https://mimes.hepforge.org}{\includegraphics[width=2.5cm]{hepforge.png}}
	\end{figure}
