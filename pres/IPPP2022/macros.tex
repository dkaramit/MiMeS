...
\newenvironment{rd}[1]{{\color{red} #1}}

\newenvironment{gr}[1]{{\color{gray} #1}}
...
\newcommand{\fontF}{\fontsize{6}{1} \selectfont}
\newcommand{\fontT}{\fontsize{3}{1} \selectfont}

\newcommand{\fontL}{\fontsize{7}{1} \selectfont}
\newcommand{\fontB}{\fontsize{8}{1} \selectfont}
...
\lstset{
	...
	emph=[3]{Solver,Method,LD}, emphstyle=[3]{\color{green!80!black}}
}

\newcommand*\codeL{\lstinline[language=c++,basicstyle=\Large]}

\newcommand*\codeB{\lstinline[language=c++,basicstyle=\fontB]}
