...
\begin{frame}{}%\transblindsvertical
	...
	\begin{center}
		...
		\bl{ 
			...
			{\bl \fontF Astron. Astrophys. \textbf{641} (2020), A6},
...
%	\end{center}
	...
	%
	\begin{itemize}
		\item The approximations can be tested against numerical results in a case-by-case basis. \emph{No measure of accuracy}. %There is no way to tell if they will work in new models and cosmological scenarios.
